...
Atlas supports two key content editor modes: an MS Word-like WYSIWYG editing mode and a text markup mode.  In the WYSIWYG mode, the author writed in an online environment that is similar to a tradional word processor, like MS Word.
